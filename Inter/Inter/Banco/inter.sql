...
INSERT INTO CGE_CRITERIOS_GERAIS VALUES(0, 'Apresentação', 'Maneira do aluno se expressar durante a exposição de suas ideias.',1),
(0, 'Postura', 'Comportamento do aluno durante a apresentação.',1),
(0, 'Vestimeta', 'Roupa do aluno no dia da apresentação.',1),
(0, 'Conhecimento', 'Conhecimento do aluno sobre o assunto explanado.',1);
