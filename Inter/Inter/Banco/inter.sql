...
INSERT INTO SAN_SEMESTRE_ANO VALUES
(0, 2014, 1, 0),
(0, 2014, 2, 0),
(0, 2015, 1, 1);
...
DELIMITER |
	...
	FOR EACH ROW 
		...
		SET @NEW_ATIVO = 'ATIVO';
 			...
 			(NULL, sysdate(), NEW.CGE_USUARIO, 'INSERCAO', 'CGE_CRITERIOS_GERAIS', 'NOVO CRITERIO', CONCAT(NEW.CGE_CODIGO, ' - ',NEW.CGE_NOME, ' - ', NEW.CGE_DESCRICAO, ' - ', @NEW_ATIVO));
 		END;
|
...
DELIMITER |
    ...
    FOR EACH ROW 
        ...
        END IF;
 			...
 			INSERT INTO AUD_AUDITORIA VALUES
 			(NULL, sysdate(), NEW.CGE_USUARIO, 'ALTERACAO', 'CGE_CRITERIOS_GERAIS', CONCAT(OLD.CGE_CODIGO, ' - ',OLD.CGE_NOME, ' - ', OLD.CGE_DESCRICAO, ' - ', @OLD_ATIVO), CONCAT(NEW.CGE_CODIGO, ' - ',NEW.CGE_NOME, ' - ', NEW.CGE_DESCRICAO, ' - ', @NEW_ATIVO));
 		END;
|
...
DELIMITER |
	...
	FOR EACH ROW 
		BEGIN
  			INSERT INTO AUD_AUDITORIA VALUES
  			(NULL, sysdate(), NEW.CPI_USUARIO, 'INSERCAO', 'CPI_CRITERIO_PI', 'NOVO CRITERIO RELACIONADO AO PI', CONCAT(NEW.CPI_CODIGO, ' - ',NEW.CGE_CODIGO, ' - ', NEW.PRI_CODIGO, ' - ', NEW.ADI_CODIGO, ' - ', NEW.CPI_PESO));
  		END;
|
...
DELIMITER |
	...
	FOR EACH ROW 
		BEGIN
   			INSERT INTO AUD_AUDITORIA VALUES
   			(NULL, sysdate(), NEW.EVE_USUARIO, 'INSERCAO', 'EVE_EVENTOS', 'NOVO EVENTO', CONCAT(NEW.EVE_CODIGO, ' - ', NEW.PRI_CODIGO, ' - ', NEW.EVE_DATA, ' - ', NEW.EVE_TIPO));
   		END;
|
...
DELIMITER |
	...
	FOR EACH ROW 
		BEGIN
  			INSERT INTO AUD_AUDITORIA VALUES
  			(NULL, sysdate(), NEW.GAL_USUARIO, 'INSERCAO', 'GAL_GRUPO_ALUNO', 'NOVO ALUNO RELACIONADO AO GRUPO', CONCAT(NEW.ALU_MATRICULA, ' - ', NEW.GRU_CODIGO));
  		END;
|
...
DELIMITER |
	...
	FOR EACH ROW 
		...
		SET @NEW_FINALIZADO = 'EM ANDAMENTO';
  			...
  			INSERT INTO AUD_AUDITORIA VALUES
  			(NULL, sysdate(), NEW.GRU_USUARIO, 'INSERCAO', 'GRU_GRUPO', 'NOVO GRUPO', CONCAT(NEW.GRU_CODIGO, ' - ', NEW.PRI_CODIGO, ' - ', NEW.GRU_NOME_PROJETO, ' - ', @NEW_FINALIZADO));
  		END;
|
...
DELIMITER |
    ...
    FOR EACH ROW 
        ...
        END IF;
 			...
 			INSERT INTO AUD_AUDITORIA VALUES
 			(NULL, sysdate(), NEW.GRU_USUARIO, 'ALTERACAO', 'GRU_GRUPO', CONCAT(OLD.GRU_CODIGO, ' - ',OLD.PRI_CODIGO, ' - ', OLD.GRU_NOME_PROJETO, ' - ', @OLD_FINALIZADO), CONCAT(NEW.GRU_CODIGO, ' - ', NEW.PRI_CODIGO, ' - ', NEW.GRU_NOME_PROJETO, ' - ', @NEW_FINALIZADO));
 		END;
|
...
DELIMITER |
	...
	FOR EACH ROW 
		BEGIN
  			INSERT INTO AUD_AUDITORIA VALUES
  			(NULL, sysdate(), NEW.HIS_USUARIO, 'INSERCAO', 'HIS_HISTORICO_ALUNO_DISCIPLINA', 'NOVA NOTA INSERIDA', CONCAT(NEW.HIS_CODIGO, ' - ', NEW.ALU_MATRICULA, ' - ', NEW.CPI_CODIGO, ' - ', NEW.HIS_NOTA));
  		END;
|
...
DELIMITER |
    ...
    FOR EACH ROW 
		BEGIN
 			INSERT INTO AUD_AUDITORIA VALUES
 			(NULL, sysdate(), NEW.HIS_USUARIO, 'ALTERACAO', 'HIS_HISTORICO_ALUNO_DISCIPLINA', CONCAT(OLD.HIS_CODIGO, ' - ',OLD.ALU_MATRICULA, ' - ', OLD.CPI_CODIGO, ' - ', OLD.HIS_NOTA), CONCAT(NEW.HIS_CODIGO, ' - ', NEW.ALU_MATRICULA, ' - ', NEW.CPI_CODIGO, ' - ', NEW.HIS_NOTA));
 		END;
|
...
DELIMITER |
	...
	FOR EACH ROW
		BEGIN
  			INSERT INTO AUD_AUDITORIA VALUES
  			(NULL, sysdate(), NEW.MSG_USUARIO, 'INSERCAO', 'MSG_MENSAGEM', 'NOVA MENSAGEM', CONCAT(NEW.MSG_CODIGO, ' - ', NEW.REQ_CODIGO, ' - ', NEW.PRO_MATRICULA, ' - ', NEW.PER_MATRICULA, ' - ', NEW.MSG_DT_ENVIO, ' - ', NEW.MSG_CONTEUDO));
  		END;
|
...
DELIMITER |
	...
	FOR EACH ROW 
		...
		SET @NEW_PERFIL = 'COORDENADOR';
  			...
  			INSERT INTO AUD_AUDITORIA VALUES
  			(NULL, sysdate(), NEW.PER_USUARIO, 'INSERCAO', 'PER_PERFIL', 'NOVO COORDENADOR', CONCAT(NEW.PER_MATRICULA, ' - ', @NEW_PERFIL));
  		END;
|
...
DELIMITER |
    ...
    FOR EACH ROW 
		BEGIN
 			INSERT INTO AUD_AUDITORIA VALUES
 			(NULL, sysdate(), NEW.PER_USUARIO, 'ALTERACAO', 'PER_PERFIL', CONCAT(OLD.PER_MATRICULA, ' - ',OLD.PER_DESCRICAO), CONCAT(NEW.PER_MATRICULA, ' - ', NEW.PER_DESCRICAO));
 		END;
|
...
DELIMITER |
	...
	FOR EACH ROW 
		...
		SET @OLD_PERFIL = 'COORDENADOR';
			INSERT INTO AUD_AUDITORIA VALUES
            (NULL, SYSDATE(), OLD.PER_USUARIO, 'EXCLUSAO', 'PER_PERFIL', CONCAT(OLD.PER_MATRICULA, ' - ', @OLD_PERFIL), 'COORDENADOR EXCLUIDO');
		END;
|
...
DELIMITER |
	...
	FOR EACH ROW 
		...
		SET @NEW_STATUS = 'ABERTO';
  			INSERT INTO AUD_AUDITORIA VALUES
  			(NULL, sysdate(), NEW.REQ_USUARIO, 'INSERCAO', 'REQ_REQUERIMENTO', 'NOVO REQUERIMENTO', CONCAT(NEW.REQ_CODIGO, ' - ', NEW.PRO_MATRICULA, ' - ', NEW.GRU_CODIGO, ' - ', NEW.REQ_ASSUNTO, ' - ', NEW.REQ_DT_REQUISICAO, ' - ', NEW.REQ_CATEGORIA, ' - ', @NEW_STATUS,  ' - ', NEW.REQ_DT_MODIFICADO));
  		END;
|
...
DELIMITER |
    ...
    FOR EACH ROW 
        ...
        END IF;
 			...
 			INSERT INTO AUD_AUDITORIA VALUES
 			(NULL, sysdate(), NEW.REQ_USUARIO, 'ALTERACAO', 'REQ_REQUERIMENTO', CONCAT(OLD.REQ_CODIGO, ' - ', OLD.PRO_MATRICULA, ' - ', OLD.GRU_CODIGO, ' - ', OLD.REQ_ASSUNTO, ' - ', OLD.REQ_DT_REQUISICAO, ' - ', OLD.REQ_CATEGORIA, ' - ', @OLD_STATUS, ' - ', OLD.REQ_DT_MODIFICADO ), CONCAT(NEW.REQ_CODIGO, ' - ', NEW.PRO_MATRICULA, ' - ', NEW.GRU_CODIGO, ' - ', NEW.REQ_ASSUNTO, ' - ', NEW.REQ_DT_REQUISICAO, ' - ', NEW.REQ_CATEGORIA, ' - ', @NEW_STATUS, ' - ', NEW.REQ_DT_MODIFICADO));
 		END;
|
