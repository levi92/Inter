...
@OLD_CHARACTER_SET_RESULTS=@@CHARACTER_SET_R
...
`adi_atribuicao_disciplina_ibfk_1` FOREIGN 

KEY (`TRM_CODIGO`) REFERENCES `trm_turma` 

(`TRM_CODIGO`) ON DELETE CASCADE ON UPDATE 

CASCADE,
  CONSTRAINT 

`adi_atribuicao_disciplina_ibfk_2` FOREIGN 

KEY (`PRO_MATRICULA`) REFERENCES 

`pro_professor` (`PRO_MATRICULA`) ON DELETE 

CASCADE ON UPDATE CASCADE,
  CONSTRAINT 

`adi_atribuicao_disciplina_ibfk_3` FOREIGN 

KEY (`DGE_CODIGO`) REFERENCES 

`dge_disciplinas_gerais` (`DGE_CODIGO`) ON 
...
`adi_atribuicao_disciplina` DISABLE KEYS */;
INSERT INTO `adi_atribuicao_disciplina` 

(`ADI_CODIGO`,`ADI_SEMESTRE_ANO`,`ADI_MAE`,`

TRM_CODIGO`,`PRO_MATRICULA`,`DGE_CODIGO`) 
...
`adi_atribuicao_disciplina` ENABLE KEYS */;
...
AUTO_INCREMENT,
  ...
  CONSTRAINT `alu_aluno_ibfk_1` FOREIGN KEY 

(`PES_CODIGO`) REFERENCES `pes_pessoas` 

(`PES_CODIGO`) ON DELETE CASCADE ON UPDATE 
...
/*!40000 ALTER TABLE `alu_aluno` DISABLE 

KEYS */;
INSERT INTO `alu_aluno` 

(`ALU_MATRICULA`,`PES_CODIGO`) VALUES 
 (1,7),
 (2,8),
 (3,9);
...
/*!40000 ALTER TABLE `cge_criterios_gerais` 

DISABLE KEYS */;
INSERT INTO `cge_criterios_gerais` 

(`CGE_CODIGO`,`CGE_NOME`,`CGE_DESCRICAO`,`CG

E_ATIVO`) VALUES 
 (1,'Postura','Desenvoltura do aluno na 

apresentação',1),
 (2,'Apresentação','Maneira do aluno 

apresentar',1),
 (3,'Vestimenta','Trajes devidamente 

adequados',1),
 (4,'Conhecimento','Conhecimento do aluno 

sobre o projeto',1),
 (5,'Fala','Dicção do aluno na 
...
AUTO_INCREMENT,
  ...
  CONSTRAINT `cpi_criterio_pi_ibfk_1` 

FOREIGN KEY (`PRI_CODIGO`) REFERENCES 

`pri_projeto_inter` (`PRI_CODIGO`) ON DELETE 

CASCADE ON UPDATE CASCADE,
  CONSTRAINT `cpi_criterio_pi_ibfk_2` 

FOREIGN KEY (`ADI_CODIGO`) REFERENCES 

`pri_projeto_inter` (`ADI_CODIGO`) ON DELETE 

CASCADE ON UPDATE CASCADE,
  CONSTRAINT `cpi_criterio_pi_ibfk_3` 

FOREIGN KEY (`CGE_CODIGO`) REFERENCES 

`cge_criterios_gerais` (`CGE_CODIGO`) ON 
...
/*!40000 ALTER TABLE `cpi_criterio_pi` 
...
/*!40000 ALTER TABLE `cur_curso` DISABLE 

KEYS */;
INSERT INTO `cur_curso` 

(`CUR_CODIGO`,`CUR_NOME`,`CUR_SIGLA`) VALUES 
 (1,'Análise e Desenvolvimento de 

Sistemas','ADS'),
 (2,'Gestão Empresarial','GE'),
 (3,'Gestão Financeira','GF'),
 (4,'Logística','LOG'),
 (5,'Gestão da Tecnologia da 
...
(`ALU_MATRICULA`,`ADI_CODIGO`),
  KEY `ADI_CODIGO` (`ADI_CODIGO`),
  CONSTRAINT `dal_disciplina_aluno_ibfk_1` 

FOREIGN KEY (`ALU_MATRICULA`) REFERENCES 

`alu_aluno` (`ALU_MATRICULA`) ON DELETE 

CASCADE ON UPDATE CASCADE,
  CONSTRAINT `dal_disciplina_aluno_ibfk_2` 

FOREIGN KEY (`ADI_CODIGO`) REFERENCES 

`adi_atribuicao_disciplina` (`ADI_CODIGO`) 
...
/*!40000 ALTER TABLE `dal_disciplina_aluno` 

DISABLE KEYS */;
INSERT INTO `dal_disciplina_aluno` 

(`ALU_MATRICULA`,`ADI_CODIGO`,`DAL_SEMESTRE_
...
`dge_disciplinas_gerais` DISABLE KEYS */;
INSERT INTO `dge_disciplinas_gerais` 

(`DGE_CODIGO`,`DGE_NOME`,`DGE_SIGLA`) VALUES 
...
`dge_disciplinas_gerais` ENABLE KEYS */;
...
AUTO_INCREMENT,
  ...
  KEY `PRI_CODIGO` (`PRI_CODIGO`),
  KEY `ADI_CODIGO` (`ADI_CODIGO`),
  CONSTRAINT `eve_eventos_ibfk_1` FOREIGN 

KEY (`PRI_CODIGO`) REFERENCES 

`pri_projeto_inter` (`PRI_CODIGO`) ON DELETE 

CASCADE ON UPDATE CASCADE,
  CONSTRAINT `eve_eventos_ibfk_2` FOREIGN 

KEY (`ADI_CODIGO`) REFERENCES 
...
/*!40000 ALTER TABLE `eve_eventos` DISABLE 

KEYS */;
/*!40000 ALTER TABLE `eve_eventos` ENABLE 
...
CREATE TABLE `gal_grupo_aluno` (
  ...
  CONSTRAINT `gal_grupo_aluno_ibfk_1` 

FOREIGN KEY (`GRU_CODIGO`) REFERENCES 

`gru_grupo` (`GRU_CODIGO`) ON DELETE CASCADE 

ON UPDATE CASCADE,
  CONSTRAINT `gal_grupo_aluno_ibfk_2` 

FOREIGN KEY (`ALU_MATRICULA`) REFERENCES 

`dal_disciplina_aluno` (`ALU_MATRICULA`) ON 
...
/*!40000 ALTER TABLE `gal_grupo_aluno` 
...
AUTO_INCREMENT,
  ...
  KEY `PRI_CODIGO` (`PRI_CODIGO`),
  KEY `ADI_CODIGO` (`ADI_CODIGO`),
  CONSTRAINT `gru_grupo_ibfk_1` FOREIGN KEY 

(`PRI_CODIGO`) REFERENCES 

`pri_projeto_inter` (`PRI_CODIGO`) ON DELETE 

CASCADE ON UPDATE CASCADE,
  CONSTRAINT `gru_grupo_ibfk_2` FOREIGN KEY 

(`ADI_CODIGO`) REFERENCES 
...
/*!40000 ALTER TABLE `gru_grupo` DISABLE 
...
`his_historico_disciplina_ibfk_1` FOREIGN 

KEY (`CPI_CODIGO`) REFERENCES 

`cpi_criterio_pi` (`CPI_CODIGO`) ON DELETE 

CASCADE ON UPDATE CASCADE,
  CONSTRAINT 

`his_historico_disciplina_ibfk_2` FOREIGN 
...
`his_historico_disciplina_ibfk_3` FOREIGN 

KEY (`ALU_MATRICULA`) REFERENCES 

`gal_grupo_aluno` (`ALU_MATRICULA`) ON 
...
`his_historico_disciplina` DISABLE KEYS */;
/*!40000 ALTER TABLE 

`his_historico_disciplina` ENABLE KEYS */;


--
-- Definition of table 

`mdd_media_disciplina`
--

DROP TABLE IF EXISTS `mdd_media_disciplina`;
CREATE TABLE `mdd_media_disciplina` (
  `MDD_CODIGO` int(11) NOT NULL 
...
AUTO_INCREMENT,
  ...
  KEY `PRI_CODIGO` (`PRI_CODIGO`),
  KEY `ADI_CODIGO` (`ADI_CODIGO`),
  CONSTRAINT `mdd_media_disciplina_ibfk_1` 
...
CASCADE ON UPDATE CASCADE,
  CONSTRAINT `mdd_media_disciplina_ibfk_2` 
...
/*!40000 ALTER TABLE `mdd_media_disciplina` 
...
/*!40000 ALTER TABLE `pes_pessoas` DISABLE 

KEYS */;
INSERT INTO `pes_pessoas` 

(`PES_CODIGO`,`PES_NOME`,`PES_EMAIL`,`PES_TE

L`,`PES_CEL`) VALUES 
 

(4,'Camila','camila@fatecguaratingueta.edu.b

r','3131-3232','997998778'),
 

(5,'Rodrigo','rodrigo@fatecguaratingueta.edu

.br','3131-3232','997998778'),
 

(6,'Claudemir','claudemir@fatecguaratingueta

.edu.br','3131-3232','997998778'),
 

(7,'Gabriel','gabriel@fatecguaratingueta.edu

.br','3131-3232','997998778'),
 

(8,'Douglas','douglas@fatecguaratingueta.edu

.br','3131-3232','997998778'),
 

(9,'Felipe','felipe@fatecguaratingueta.edu.b

r','3131-3232','997998778');
/*!40000 ALTER TABLE `pes_pessoas` ENABLE 
...
AUTO_INCREMENT,
  ...
  KEY `ADI_CODIGO` (`ADI_CODIGO`),
  KEY `pri_projeto_inter_ibfk_2` 

(`SAN_SEMESTRE_ANO`),
  CONSTRAINT `pri_projeto_inter_ibfk_1` 
...
ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `pri_projeto_inter_ibfk_2` 

FOREIGN KEY (`SAN_SEMESTRE_ANO`) REFERENCES 

`san_semestre_ano` (`san_codigo`) ON DELETE 
...
/*!40000 ALTER TABLE `pri_projeto_inter` 

DISABLE KEYS */;
INSERT INTO `pri_projeto_inter` 

(`PRI_CODIGO`,`SAN_SEMESTRE_ANO`,`PRI_DESCRI

CAO`,`PRI_EMENTA`,`ADI_CODIGO`) VALUES 
 (1,3,'PI','Teste',3),
...
AUTO_INCREMENT,
  ...
  `PRO_CHAVE_SENHA` varchar(10) DEFAULT 

NULL,
  `PES_CODIGO` int(11) NOT NULL,
  PRIMARY KEY (`PRO_MATRICULA`),
  KEY `PES_CODIGO` (`PES_CODIGO`),
  CONSTRAINT `pro_professor_ibfk_1` FOREIGN 

KEY (`PES_CODIGO`) REFERENCES `pes_pessoas` 
...
/*!40000 ALTER TABLE `pro_professor` DISABLE 

KEYS */;
INSERT INTO `pro_professor` 

(`PRO_MATRICULA`,`PRO_ADMINISTRADOR`,`PRO_SE

NHA`,`PRO_CHAVE_SENHA`,`PES_CODIGO`) VALUES 
 

(4,1,'b19df6c68faafd4c9925f0dfaf9b1eae4ad135

25','chavesenha',4),
 

(5,0,'1ac3cf657b0c16fc280e910c6bcbaaa39e2436

56','chavesenha',5),
 

(6,0,'959c8d10fe2052757c4645650eff4825bbf206

b0','chavesenha',6);
/*!40000 ALTER TABLE `pro_professor` ENABLE 
...
AUTO_INCREMENT,
  ...
  KEY `PRO_MATRICULA` (`PRO_MATRICULA`),
  KEY `req_requerimento_ibfk_2` 

(`GRU_CODIGO`),
  CONSTRAINT `req_requerimento_ibfk_1` 

FOREIGN KEY (`PRO_MATRICULA`) REFERENCES 

`pro_professor` (`PRO_MATRICULA`) ON DELETE 

CASCADE ON UPDATE CASCADE,
  CONSTRAINT `req_requerimento_ibfk_2` 
...
/*!40000 ALTER TABLE `req_requerimento` 
...
/*!40000 ALTER TABLE `san_semestre_ano` 

DISABLE KEYS */;
INSERT INTO `san_semestre_ano` 

(`san_codigo`,`san_ano`,`san_semestre`,`san_
...
AUTO_INCREMENT,
  ...
  CONSTRAINT `trm_turma_ibfk_1` FOREIGN KEY 

(`TUR_CODIGO`) REFERENCES `tur_turno` 

(`TUR_CODIGO`) ON DELETE CASCADE ON UPDATE 

CASCADE,
  CONSTRAINT `trm_turma_ibfk_2` FOREIGN KEY 

(`CUR_CODIGO`) REFERENCES `cur_curso` 

(`CUR_CODIGO`) ON DELETE CASCADE ON UPDATE 
...
/*!40000 ALTER TABLE `trm_turma` DISABLE 

KEYS */;
INSERT INTO `trm_turma` 

(`TRM_CODIGO`,`TRM_NOME`,`TUR_CODIGO`,`CUR_C
...
/*!40000 ALTER TABLE `tur_turno` DISABLE 

KEYS */;
INSERT INTO `tur_turno` 

(`TUR_CODIGO`,`TUR_NOME`) VALUES 
 (1,'Tarde'),
 (2,'Noite');
...
(per_matricula int not null primary key,
