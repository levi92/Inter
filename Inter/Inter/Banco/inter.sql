...
DELIMITER |
	...
	FOR EACH ROW 
		...
		SET @NEW_STATUS = 'ABERTO';
  			INSERT INTO AUD_AUDITORIA VALUES
  			(0, sysdate(), NEW.REQ_USUARIO, 'INSERCAO', 'REQ_REQUERIMENTO', 'NOVO REQUERIMENTO', CONCAT(NEW.REQ_CODIGO, ' - ', NEW.PRO_MATRICULA, ' - ', NEW.GRU_CODIGO, ' - ', NEW.REQ_ASSUNTO, ' - ', NEW.REQ_DT_REQUISICAO, ' - ', NEW.REQ_CATEGORIA, ' - ', @NEW_STATUS,  ' - ', NEW.REQ_DT_MODIFICADO));
  		END;
|
